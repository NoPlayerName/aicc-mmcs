...
class AceProductSheetExport implements FromCollection, WithHeadings, WithMapping, WithTitle, ShouldAutoSize, WithStyles
{
    protected $data;
    protected $dateRange;
    protected $title;
    ...
    public function headings(): array
    {
        ...
        $productName = (is_iterable($this->data) && count($this->data) > 0) ? ($this->data->first()->product_name ?? '-') : '-';

        $row1 = ['Shift: ' . ($this->shift ?: 'D, S & N')];
        $row2 = ['Product: ' . $productName];
