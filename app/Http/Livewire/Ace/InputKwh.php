...
class InputKwh extends Component
{
    ...
    public function loadData()
    {
        if ($this->edit) {
            ...
            $data = app(MaterialUseAceService::class)->getKwh($this->chargeId);
            // dd($data);
            $this->form = [
    ...
    public function save()
    {
        ...
        if ($this->edit) {
            ...
            $save = app(MaterialUseAceService::class)->UpdateKwh($this->form);
            if ($save) {
                $this->loadData();
            ...
            $save = app(MaterialUseAceService::class)->saveKwh($data);
    ...
    {
        return view('livewire.ace.input-kwh');
    }
}
