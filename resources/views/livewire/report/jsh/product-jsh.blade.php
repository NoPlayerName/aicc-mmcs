        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">JSH Melting Product Report</h4>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select class="form-control select2" id="product" wire:model.live="product">
                                        <option value="">select</option>
                                        @foreach ($productSelect as $fc )
                                        <option value="{{ $fc->id }}">{{ $fc->model }} - {{ $fc->alias }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="shift" wire:model.live="shift">
                                        <option value="">select</option>
                                        ...
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th colspan="{{ count($dateRange) }}">
                                                    ...
                                                    @if(!empty($data) && is_object($data) && method_exists($data,
                                                    'first') && $data->first())
