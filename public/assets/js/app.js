    ...
    function t(e) {
        ...
        "light-mode-switch" === e
            ? (s("#dark-mode-switch").prop("checked", !1),
              ...
              s("#app-style").attr("href", base + "/assets/css/app.min.css"),
            ...
            ? (s("#light-mode-switch").prop("checked", !1),
              ...
              s("#bootstrap-style").attr(
                  "href",
                  base + "/assets/css/bootstrap-dark.min.css"
              ),
              s("#app-style").attr(
                  "href",
                  base + "/assets/css/app-dark.min.css"
              ),
            ...
            : 1 == s("#rtl-mode-switch").prop("checked") &&
              ...
              s("#app-style").attr(
                  "href",
                  base + "/assets/css/app-rtl.min.css"
              ),
