...
return new class extends Migration
{
    ...
    {
        Schema::connection('material-use')->create('tb_material_adjust_ace', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('material-use')->dropIfExists('tb_material_adjust_ace');
    }
};
